...
<html>
  ...
  <body>
  <form action="film_addFilm.action" method="post" enctype="multipart/form-data">
  电影名称：<input type="text" name="film.name"><br>
  出演明星：<input type="text" name="film.star"><br>
  电影类型：<select id="type" name="type">
  </select><br>
  电影详情：<textarea rows="5" cols="" name="film.content"></textarea><br>
